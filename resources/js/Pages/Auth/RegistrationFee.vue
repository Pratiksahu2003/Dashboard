    ...
    <AuthLayout>
        ...
        <div class="space-y-10">
            ...
            <div class="space-y-4 px-2">
                <div v-for="(benefit, i) in ['Lifetime Dashboard Access', 'Verified Professional Badge', 'Global Network Connectivity', 'Priority Support']" :key="i" class="flex items-center text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">
            ...
            <div class="space-y-4">
                <SuButton @click="proceedToPayment" class="w-full">
                    Complete Activation via Cashfree
                </SuButton>
                
                <button @click="handleLogout" class="w-full text-[10px] font-black text-gray-300 hover:text-gray-500 uppercase tracking-[0.2em] transition-colors italic">
                    Cancel & Revert to Secure Gateway
                </button>
            </div>
        </div>
        <template #footer>
