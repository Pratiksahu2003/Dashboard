...
import { getTeacherReviewStats, listTeacherReviews } from '@/services/reviewApi';
    ...
    <div v-else-if="teacher" class="relative max-w-6xl mx-auto px-1">
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8 mb-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div v-if="fullAddressLines.length || socialLinks.length || discordUsername || genderLabel || dateOfBirth || nationalityLabel || completionPct != null" class="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-[0_8px_30px_-12px_rgba(15,23,42,0.08)] sm:p-8">
            <div class="mb-6 flex items-center gap-3">
            ...
            <div v-if="socialLinks.length || discordUsername">
      ...
      <!-- Create lead (docs/LeadCreateApi.md): creator user_id from session + body; lead_owner_id = tutor -->
      <div class="mb-8">
        <CreateLeadForm
