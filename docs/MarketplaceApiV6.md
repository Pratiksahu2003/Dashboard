...
*   [Menu 1: Public Listing (Discovery & Purchase)](#menu-1-public-listing-discovery--purchase)
*   [Menu 2: Own Listing Management (Seller Dashboard)](#menu-2-own-listing-management-seller-dashboard)
*   [Wallet & Commissions Information](#wallet--commissions)
*   [Data Reference](#data-reference)

---

## Menu 1: Public Listing (Discovery & Purchase)
...
| | |
|---|---|
| **Endpoint** | `GET /api/v6/marketplace/listings` |
...
| | |
|---|---|
| **Endpoint** | `GET /api/v6/marketplace/listings/{id}` |
| **Access** | Protected (auth:sanctum) |
...
| | |
|---|---|
| **Endpoint** | `GET /api/v6/marketplace/trending` |
| **Access** | Protected (auth:sanctum) |
...
| | |
|---|---|
| **Endpoint** | `GET /api/v6/marketplace/plans` |
| **Access** | Protected (auth:sanctum) |
...
| | |
|---|---|
| **Endpoint** | `POST /api/v6/marketplace/listings/{id}/purchase` |
| **Access** | Protected (auth:sanctum) |
...
| | |
|---|---|
| **Endpoint** | `POST /api/v6/marketplace/listings/{id}/contact` |
| **Access** | Protected (auth:sanctum) |
...
| | |
|---|---|
| **Endpoint** | `GET /api/v6/marketplace/listings/{id}/download` |
| **Access** | Protected (auth:sanctum) |
...
## Menu 2: Own Listing Management (Seller Dashboard)
...
### 8. List My Listings
Returns a paginated list of listings created by the authenticated user.

| | |
|---|---|
| **Endpoint** | `GET /api/v6/marketplace/my-listings` |
| **Access** | Protected (auth:sanctum) |
...
| | |
|---|---|
| **Endpoint** | `DELETE /api/v6/marketplace/my-listings/{id}` |
| **Access** | Protected (auth:sanctum) |
